...
[![版本](https://img.shields.io/badge/version-1.6.0-blue.svg)](https://github.com/hulion/nextpua)
...
```bash
# 1. 新增 marketplace
claude plugin marketplace add hulion/nextpua

# 2. 安裝插件
claude plugin install c2l@nextpua
```
